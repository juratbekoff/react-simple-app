const Footer = () => {
    return (
        <div className="bg-dark text-secondary mt-5 pt-5">
                    ...
                    <div className="row">
                        <div className="col-md-4 mb-5">
                            ...
                            <div className="d-flex flex-column justify-content-start">
                                ...
                                <a className="text-secondary mb-2" href="#"><i className="fa fa-angle-right mr-2"></i>Shop
                                    Detail</a>
                                <a className="text-secondary mb-2" href="#"><i className="fa fa-angle-right mr-2"></i>Shopping
                                    Cart</a>
                        ...
                        <div className="col-md-4 mb-5">
                            ...
                            <form action="">
                                <div className="input-group">
                                    ...
                                    <div className="input-group-Footerend">
