const PorductDetails = ({ ...product }) => {
    ...
    const { title, image, price, description } = product.product
                    ...
                    <div className="h-100 bg-light p-30">
                        ...
                        <div className="d-flex flex-column pt-3 pb-4">
                            ...
                            <form action="#" style={{ display: "flex", flexDirection: "column", gap: "10px", }}>
                                <input type="text" placeholder="ismingiz" className="form-control w-75" />
                                <input type="text" placeholder="telefon raqam" className="form-control w-75" />
                                <select className="form-select form-control w-75" aria-label="Default select example">
                                    <option selected>Open this select menu</option>
                                    <option value="1">One</option>
                                    <option value="2">Two</option>
                                    <option value="3">Three</option>
                                </select>
                                <button className="btn btn-primary w-75">Buyurtma berish</button>
                            </form>
                        </div>
